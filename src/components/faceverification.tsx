                ...
                <div className="text-center">
                    ...
                    <div className="p-3 text-xs rounded-lg text-slate-500 bg-slate-50">
                        ...
                        <ul className="text-left space-y-1">
                            ...
                            <li>
                                • Select &quot;Allow&quot; when prompted for
                                camera permission
                            </li>
        ...
        return (
            <div className="flex flex-col items-center justify-center max-w-md p-6 mx-auto">
                ...
                <div className="my-6 text-center">
                    ...
                    <p className="text-sm text-slate-600">
                        Your face video has been captured and will be used for
                        verification.
                    </p>
                </div>
        ...
        <div className="flex flex-col items-center justify-center max-w-md p-2 mx-auto space-y-6 md:p-6">
            <div className="text-center space-y-3">
                ...
                <p className="text-sm leading-relaxed text-slate-600">
                    Record a 5-second video of yourself looking directly at the
                    camera
                </p>
            </div>
            ...
            <div className="flex w-full gap-3">
                ...
                <button
                    ...
                    disabled={
                        isRecording || countdown > 0 || hasPermission !== true
                    }
            ...
            <div className="text-center">
                <p className="text-xs text-gray-600">
                    Make sure you&apos;re in a well-lit area and your face is
                    clearly visible.
                </p>
            </div>
        </div>
