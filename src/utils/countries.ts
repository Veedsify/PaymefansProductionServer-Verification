export interface Countries {
   ...
   export const countries: Countries[] = [
     ...
     { name: "Bouvet Island (Bouvetoya)", code: "BV" },
     { name: "Brazil", code: "BR" },
     { name: "British Indian Ocean Territory (Chagos Archipelago)", code: "IO" },
     ...
     { name: "Fiji the Fiji Islands", code: "FJ" },
     { name: "Finland", code: "FI" },
     { name: "France, French Republic", code: "FR" },
     ...
     { name: "Poland", code: "PL" },
     { name: "Portugal, Portuguese Republic", code: "PT" },
     ...
     { name: "Somalia, Somali Republic", code: "SO" },
     ...
     { name: "Sweden", code: "SE" },
     { name: "Switzerland, Swiss Confederation", code: "CH" },
     ...
     { name: "Uruguay, Eastern Republic of", code: "UY" },
